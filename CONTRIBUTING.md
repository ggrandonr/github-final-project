# Contributing to Micro-finance Startup 'Empowering Communities'

Empowering Communities is a micro-finance startup with the mission to empower and provide opportunities to low income individuals. All contributions, bug reports, bug fixes, documentation improvements, enhancements, and ideas are welcome. You can contribute in different ways:

- Writing tutorials and blog posts
- Improving the documentation
- Submitting bug reports and feature requests
- Forking this repository and submitting a pull request
- Hosting a seismic sensor to expand the network (send us an email at [hello@empowercommunities.com](mailto:hello@empowercommunities.com))

Please read our [contributing guide](https://github.com/ggrandonr/github-final-project/edit/main/CONTRIBUTING.md) here.

## Technical Steering Committee (TSC)

The TSC will be responsible for all technical oversight of the Empowering Communities project. Participation in the Project through becoming a Contributor and Committer is open to anyone.
...
- [Gonzalo Grandón](https://github.com/ggrandonr) - Developer
